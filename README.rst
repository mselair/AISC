...
This software is licensed under the Mayo Foundation for Medical Education and Research (MFMER). See `LICENCE <https://github.com/mselair/AISC/blob/master/LICENSE>`_ file in the root directory of this project.
